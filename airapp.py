...
:root{--ink:#f7f2ff;--ink-soft:#d8d0e4;--ink-muted:#a89ab8;--accent:#d9b5ff;--accent2:#ff91cf;--cyan:#7dd3fc;--glass:rgba(255,255,255,.075);--glass2:rgba(255,255,255,.035);--edge:rgba(255,255,255,.22);--edge2:rgba(255,255,255,.42);--r-lg:26px;--r-xl:34px;}
html,body,[class*="css"]{font-family:'Manrope',system-ui,sans-serif!important;color:var(--ink)!important;-webkit-font-smoothing:antialiased;scroll-behavior:smooth;}
.stApp{min-height:100vh!important;background:#03040a!important;position:relative!important;overflow:hidden!important;}
.stApp:before{content:"";position:fixed;inset:-20%;z-index:0;pointer-events:none;background:radial-gradient(circle at 20% 18%,rgba(135,92,255,.22),transparent 24%),radial-gradient(circle at 82% 12%,rgba(255,120,210,.16),transparent 22%),radial-gradient(circle at 55% 85%,rgba(80,180,255,.12),transparent 26%),linear-gradient(180deg,#050613 0%,#090817 50%,#03040a 100%);}
.stApp:after{content:"";position:fixed;inset:0;z-index:0;pointer-events:none;opacity:.28;background-image:radial-gradient(circle,rgba(255,255,255,.38) 0 1px,transparent 1.4px),radial-gradient(circle,rgba(170,210,255,.45) 0 1px,transparent 1.6px),linear-gradient(rgba(255,255,255,.018) 1px,transparent 1px),linear-gradient(90deg,rgba(255,255,255,.014) 1px,transparent 1px);background-size:160px 160px,260px 260px,58px 58px,58px 58px;background-position:0 0,60px 80px,0 0,0 0;animation:starsDrift 55s linear infinite;mask-image:linear-gradient(to bottom,black 0%,black 72%,transparent 100%);}
@keyframes starsDrift{to{background-position:260px 180px,-180px 260px,0 120px,120px 0}}
.space-scene{position:fixed;inset:0;z-index:1;pointer-events:none;overflow:hidden}.planet{position:absolute;border-radius:50%;filter:blur(.1px);opacity:.32}.planet.one{width:190px;height:190px;right:8%;top:8%;background:radial-gradient(circle at 35% 28%,#fff,rgba(217,181,255,.8) 8%,rgba(95,72,180,.45) 38%,rgba(20,18,55,.1) 70%);box-shadow:0 0 90px rgba(160,120,255,.22);animation:floatPlanet 18s ease-in-out infinite}.planet.two{width:120px;height:120px;left:6%;bottom:12%;background:radial-gradient(circle at 35% 30%,rgba(125,211,252,.9),rgba(70,90,200,.35) 48%,transparent 72%);animation:floatPlanet 22s ease-in-out infinite reverse}.meteor{position:absolute;width:170px;height:1px;background:linear-gradient(90deg,transparent,#fff,rgba(217,181,255,.5),transparent);opacity:.0;transform:rotate(-22deg);filter:drop-shadow(0 0 8px rgba(255,255,255,.7));animation:meteor 8s linear infinite}.meteor.m1{left:10%;top:15%;animation-delay:1s}.meteor.m2{left:55%;top:25%;animation-delay:4.5s}.ufo{position:absolute;left:72%;top:62%;width:74px;height:28px;opacity:.10;animation:ufoMove 24s ease-in-out infinite}.ufo:before{content:"";position:absolute;left:14px;top:0;width:46px;height:22px;border-radius:50%;background:radial-gradient(circle at 50% 15%,rgba(255,255,255,.7),rgba(125,211,252,.28) 48%,transparent 72%)}.ufo:after{content:"";position:absolute;left:0;top:13px;width:74px;height:13px;border-radius:50%;background:linear-gradient(90deg,transparent,rgba(255,255,255,.55),rgba(217,181,255,.45),transparent);box-shadow:0 0 28px rgba(125,211,252,.35)}@keyframes floatPlanet{50%{transform:translateY(18px) translateX(-10px) scale(1.03)}}@keyframes meteor{0%,70%{opacity:0;transform:translate(0,0) rotate(-22deg)}74%{opacity:.65}85%{opacity:0;transform:translate(520px,210px) rotate(-22deg)}100%{opacity:0}}@keyframes ufoMove{50%{transform:translate(-120px,-34px) rotate(-3deg)}}
.main .block-container{max-width:1320px!important;padding-top:1.3rem!important;padding-bottom:4rem!important;position:relative!important;z-index:3!important}.main .block-container:before{content:"";position:absolute;inset:90px -40px auto -40px;height:520px;z-index:-1;pointer-events:none;background:radial-gradient(ellipse at center,rgba(217,181,255,.13),transparent 66%);filter:blur(45px)}
[data-testid="stSidebar"]{background:rgba(7,8,18,.62)!important;backdrop-filter:blur(42px) saturate(180%)!important;-webkit-backdrop-filter:blur(42px) saturate(180%)!important;border-right:1px solid rgba(255,255,255,.16)!important;box-shadow:20px 0 70px rgba(0,0,0,.5)!important;z-index:4!important}[data-testid="stSidebar"] *{color:var(--ink-soft)!important}
[data-testid="metric-container"],[data-testid="stForm"],[data-testid="stExpander"],[data-testid="stDataFrame"],.info-box,.result-card,.hero{background:linear-gradient(145deg,rgba(255,255,255,.19),rgba(255,255,255,.09) 38%,rgba(14,20,34,.82))!important;backdrop-filter:blur(38px) saturate(190%)!important;-webkit-backdrop-filter:blur(38px) saturate(190%)!important;border:1px solid var(--edge)!important;border-top:1px solid var(--edge2)!important;box-shadow:0 28px 80px rgba(0,0,0,.55),0 10px 28px rgba(0,0,0,.35),0 0 55px rgba(170,120,255,.10),inset 0 1px 0 rgba(255,255,255,.34),inset 0 -1px 0 rgba(255,255,255,.08)!important;position:relative!important;overflow:hidden!important}
[data-testid="metric-container"]:before,[data-testid="stForm"]:before,[data-testid="stExpander"]:before,.info-box:before,.result-card:before,.hero:before{content:"";position:absolute;inset:0;pointer-events:none;background:linear-gradient(115deg,rgba(255,255,255,.28),transparent 20%,transparent 62%,rgba(255,255,255,.08)),radial-gradient(circle at 18% 0%,rgba(255,255,255,.22),transparent 28%);opacity:.68}.hero:after,[data-testid="metric-container"]:after,[data-testid="stForm"]:after,.result-card:after,.info-box:after{content:"";position:absolute;top:-90%;left:-55%;width:52%;height:280%;pointer-events:none;background:linear-gradient(90deg,transparent,rgba(255,255,255,.0),rgba(255,255,255,.24),rgba(217,181,255,.20),transparent);transform:rotate(22deg);animation:none;opacity:0}@keyframes aiShimmer{0%,35%{left:-65%;opacity:0}50%{opacity:.55}75%,100%{left:125%;opacity:0}}
[data-testid="metric-container"]{border-radius:28px!important;padding:28px 30px!important;transition:transform .35s cubic-bezier(.2,.9,.2,1),box-shadow .35s ease!important}[data-testid="metric-container"]:hover,.result-card:hover,.info-box:hover{transform:translateY(-8px) scale(1.012)!important;box-shadow:0 38px 100px rgba(0,0,0,.66),0 0 75px rgba(217,181,255,.18),inset 0 1px 0 rgba(255,255,255,.42)!important}[data-testid="stMetricLabel"] p{color:var(--ink-muted)!important;font-size:.67rem!important;letter-spacing:.16em!important;text-transform:uppercase!important;font-weight:800!important}[data-testid="stMetricValue"],[data-testid="stMetricValue"]>div{color:var(--ink)!important;font-size:2rem!important;font-weight:750!important;letter-spacing:-.04em!important}
.hero{border-radius:34px!important;padding:34px 44px!important;margin-bottom:34px!important}.hero h1{font-family:'Space Grotesk',sans-serif!important;font-size:2.7rem!important;line-height:1.05!important;margin:0!important;background:linear-gradient(135deg,#fff 0%,#d9b5ff 48%,#ff91cf 100%);-webkit-background-clip:text!important;-webkit-text-fill-color:transparent!important}.hero p,.hero-eyebrow,.hero-glyph{display:none!important}
.stButton>button,[data-testid="stFormSubmitButton"]>button{border-radius:999px!important;border:1px solid rgba(255,255,255,.24)!important;background:linear-gradient(135deg,rgba(255,255,255,.22),rgba(255,255,255,.06)),linear-gradient(135deg,rgba(217,181,255,.38),rgba(255,145,207,.20))!important;color:#fff!important;backdrop-filter:blur(28px) saturate(180%)!important;box-shadow:0 18px 44px rgba(0,0,0,.42),0 0 35px rgba(217,181,255,.16),inset 0 1px 0 rgba(255,255,255,.35)!important;transition:all .28s cubic-bezier(.2,.9,.2,1)!important;font-family:'Space Grotesk',sans-serif!important;font-weight:800!important}.stButton>button:hover,[data-testid="stFormSubmitButton"]>button:hover{transform:translateY(-4px) scale(1.015)!important;box-shadow:0 26px 64px rgba(0,0,0,.52),0 0 58px rgba(217,181,255,.26),inset 0 1px 0 rgba(255,255,255,.45)!important}
.sidebar-brand{font-family:'Space Grotesk',sans-serif;font-size:1.45rem;font-weight:800;padding:6px 0 22px;border-bottom:1px solid rgba(255,255,255,.14);margin-bottom:22px}.sidebar-brand span{background:linear-gradient(135deg,var(--accent),var(--accent2));-webkit-background-clip:text;-webkit-text-fill-color:transparent}h1,h2,h3,h4{font-family:'Space Grotesk',sans-serif!important;color:var(--ink)!important;font-weight:750!important}.section-hd{font-family:'Space Grotesk',sans-serif!important;font-size:1.1rem!important;font-weight:750!important;color:var(--ink)!important;margin:0 0 6px!important}.section-sub,[data-testid="stMarkdownContainer"] p,[data-testid="stMarkdownContainer"] li{color:var(--ink-soft)!important;line-height:1.7!important}.info-box{border-radius:26px!important;padding:22px 28px!important}.result-card{border-radius:34px!important;padding:34px 38px!important;margin:32px 0!important}.pill{display:inline-block;padding:3px 12px;border-radius:99px;font-size:.66rem;font-weight:800;letter-spacing:.08em;text-transform:uppercase;border:1px solid transparent}.pill-expand{background:rgba(74,222,128,.15);color:#4ade80;border-color:rgba(74,222,128,.38)}.pill-maintain{background:rgba(250,204,21,.15);color:#facc15;border-color:rgba(250,204,21,.38)}.pill-optimize{background:rgba(251,146,60,.15);color:#fb923c;border-color:rgba(251,146,60,.38)}.pill-drop{background:rgba(251,113,133,.15);color:#fb7185;border-color:rgba(251,113,133,.38)}.result-expand{border-left:3px solid #4ade80!important}.result-maintain{border-left:3px solid #facc15!important}.result-optimize{border-left:3px solid #fb923c!important}.result-drop{border-left:3px solid #fb7185!important}.divider-label{display:flex;align-items:center;gap:16px;margin:40px 0 24px;color:var(--ink-muted);font-size:.68rem;font-weight:800;letter-spacing:.16em;text-transform:uppercase}.divider-label:before,.divider-label:after{content:"";flex:1;height:1px;background:linear-gradient(90deg,transparent,rgba(255,255,255,.28),transparent)}
.stTabs [data-baseweb="tab-list"]{background:rgba(255,255,255,.07)!important;backdrop-filter:blur(26px)!important;border:1px solid rgba(255,255,255,.17)!important;border-radius:24px!important;padding:5px!important;box-shadow:0 18px 50px rgba(0,0,0,.35)!important}.stTabs [data-baseweb="tab"]{border-radius:18px!important;color:var(--ink-muted)!important;font-weight:800!important;padding:9px 22px!important}.stTabs [aria-selected="true"]{background:linear-gradient(135deg,rgba(217,181,255,.28),rgba(255,145,207,.16))!important;color:var(--accent)!important;border:1px solid rgba(255,255,255,.22)!important}.stTabs [data-baseweb="tab-highlight"]{display:none!important}.stTabs [data-baseweb="tab-panel"]{padding-top:2rem!important}.stSelectbox label,.stNumberInput label,.stSlider label,.stRadio label,.stCheckbox label,.stTextInput label{color:var(--ink-soft)!important;font-weight:800!important;font-size:.78rem!important;letter-spacing:.06em!important;text-transform:uppercase!important}.stSelectbox [data-baseweb="select"] div,.stTextInput input,.stNumberInput input{color:var(--ink)!important;background:rgba(255,255,255,.06)!important;border:1px solid rgba(255,255,255,.18)!important;border-radius:15px!important}[data-testid="stExpander"],[data-testid="stDataFrame"],iframe{border-radius:26px!important}hr{border:none!important;height:1px!important;background:linear-gradient(90deg,transparent,rgba(255,255,255,.28),transparent)!important;margin:2rem 0!important}[data-testid="stHorizontalBlock"]{gap:20px!important}::-webkit-scrollbar{width:5px;height:5px}::-webkit-scrollbar-track{background:transparent}::-webkit-scrollbar-thumb{background:rgba(255,255,255,.22);border-radius:5px}@keyframes scaleUp{from{opacity:0;transform:scale(.97) translateY(18px)}to{opacity:1;transform:scale(1) translateY(0)}}
</style>
<div class="space-scene"><div class="planet one"></div><div class="planet two"></div><div class="meteor m1"></div><div class="meteor m2"></div><div class="ufo"></div><div style="position:absolute;left:-90px;top:28%;font-size:34px;opacity:.28;filter:drop-shadow(0 0 18px rgba(125,211,252,.45));animation:ufoMove 28s linear infinite">✈</div></div>
<script>
(function(){var io=new IntersectionObserver(function(entries){entries.forEach(function(e){if(e.isIntersecting){e.target.style.opacity="1";e.target.style.transform="translateY(0) scale(1)";io.unobserve(e.target);}});},{threshold:.07,rootMargin:"0px 0px -35px 0px"});function attach(){document.querySelectorAll("[data-testid='metric-container'],[data-testid='stDataFrame'],[data-testid='stExpander'],.element-container").forEach(function(el,i){if(!el.dataset.sr){el.dataset.sr="1";el.style.opacity="0";el.style.transform="translateY(34px) scale(.985)";el.style.transition="opacity .7s cubic-bezier(.22,1,.36,1) "+(i%5)*.05+"s, transform .7s cubic-bezier(.22,1,.36,1) "+(i%5)*.05+"s";io.observe(el);}})}setTimeout(attach,250);new MutationObserver(function(){setTimeout(attach,120)}).observe(document.body,{childList:true,subtree:true});})();
</script>
...
<style>
  ...
  *{box-sizing:border-box;margin:0;padding:0}html,body{width:100%;height:100%;background:transparent;overflow:hidden;font-family:'Space Grotesk',sans-serif}.card{width:100%;min-height:100%;background:linear-gradient(145deg,rgba(255,255,255,.18),rgba(255,255,255,.075) 44%,rgba(10,18,32,.88)),radial-gradient(circle at 18% 0%,rgba(255,255,255,.20),transparent 30%),radial-gradient(circle at 100% 100%,rgba(217,181,255,.11),transparent 38%);border:1px solid rgba(255,255,255,.20);border-top:1px solid rgba(255,255,255,.38);border-radius:28px;padding:22px 24px 20px;box-shadow:0 26px 70px rgba(0,0,0,.52),0 8px 24px rgba(0,0,0,.34),0 0 34px rgba(217,181,255,.10),inset 0 1px 0 rgba(255,255,255,.30);position:relative;overflow:hidden}.card:before{content:"";position:absolute;inset:0;pointer-events:none;background:linear-gradient(120deg,rgba(255,255,255,.24),transparent 22%,transparent 70%,rgba(255,255,255,.07));opacity:.62}.card:after{content:"";position:absolute;top:-110%;left:-60%;width:55%;height:310%;background:linear-gradient(90deg,transparent,rgba(255,255,255,.22),rgba(217,181,255,.16),transparent);transform:rotate(22deg);animation:none;opacity:0}.card:hover{box-shadow:0 34px 86px rgba(0,0,0,.6),0 0 46px rgba(217,181,255,.16),inset 0 1px 0 rgba(255,255,255,.36)}@keyframes chartShimmer{0%,35%{left:-70%;opacity:0}55%{opacity:.5}80%,100%{left:130%;opacity:0}}.chart-title{position:relative;z-index:2;font-size:18px;font-weight:800;color:#f7f2ff;letter-spacing:-.01em;margin-bottom:10px}svg{position:relative;z-index:2;display:block;width:100%;height:auto;overflow:visible}.axis-label{font-size:14px;fill:#bfb4ca;font-family:'Space Grotesk',sans-serif;font-weight:500}.value-label{font-size:14px;fill:#f5eff9;font-weight:700;font-family:'DM Mono',monospace}.grid-line{stroke:rgba(255,255,255,.06);stroke-width:.8;stroke-dasharray:5,4}.bar-rect{transition:opacity .2s,filter .2s;cursor:pointer}.bar-rect:hover{opacity:.92;filter:brightness(1.08)}@keyframes barGrow{from{transform:scaleY(0);transform-origin:bottom;opacity:.45}to{transform:scaleY(1);transform-origin:bottom;opacity:1}}@keyframes barGrowH{from{transform:scaleX(0);transform-origin:left;opacity:.45}to{transform:scaleX(1);transform-origin:left;opacity:1}}@keyframes fadeIn{from{opacity:0;transform:translateY(4px)}to{opacity:1;transform:translateY(0)}}.bar-anim{animation:barGrow .72s cubic-bezier(.22,1,.36,1) both}.bar-anim-h{animation:barGrowH .72s cubic-bezier(.22,1,.36,1) both}.fade-in{animation:fadeIn .55s ease both}.pie-slice{transition:opacity .2s,filter .2s;cursor:pointer}.pie-slice:hover{opacity:.92;filter:brightness(1.08)}
</style>
"""
def _fmt_money(v):
    if abs(v) >= 1_000_000:
...
def render_vbar_chart(title, labels, values, colors, height=340,
    ...
    n = len(labels)
    W, H = 940, max(height, 390)
    pad_l, pad_r, pad_t, pad_b = 96, 70, 48, 88
    ax_w = W - pad_l - pad_r
    ax_h = H - pad_t - pad_b
    bar_w = ax_w / n * 0.52
    bar_gap = ax_w / n
...
def render_hbar_chart(title, labels, values, colors, height=None, fmt_fn=None, x_label="", uid="hchart"):
    ...
    n = len(labels)
    W = 1020
    H = max(height or max(430, 54 * n + 140), 430)
    pad_l, pad_r, pad_t, pad_b = 180, 160, 56, 82
    ax_w = W - pad_l - pad_r
    ax_h = H - pad_t - pad_b
    bar_h = min(28, ax_h / n * 0.54)
    bar_gap = ax_h / n
...
<text class="axis-label" x="{pad_l-8}" y="{cy+3.5:.1f}" text-anchor="end" >{lbl}</text>
<text class="value-label fade-in" x="{pad_l+bw+12:.1f}" y="{cy+5:.1f}"
...
def render_pie_chart(title, labels, values, colors, height=320, uid="pie"):
    ...
    if total == 0:
        return ""
    W, H = 860, max(height, 410)
    cx, cy, r_outer, r_inner = W // 2, H // 2 - 10, min(W, H) // 2 - 115, 72
...
def render_grouped_bar_chart(title, group_labels, series, colors, height=300, uid="grp"):
    ...
    n_series = len(series)
    W, H = 1020, max(height, 410)
    pad_l, pad_r, pad_t, pad_b = 92, 58, 56, 105
    ax_w = W - pad_l - pad_r
    ax_h = H - pad_t - pad_b
...
<text class="value-label fade-in" x="{cx:.1f}" y="{by-5:.1f}" text-anchor="middle" 
...
def svg_chart(html_str, height):
    ...
    components.html(html_str, height=max(height + 110, 480), scrolling=False)
